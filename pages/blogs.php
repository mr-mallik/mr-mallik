...
$stories = cmsoneArticleList($filterCategory ?? 'blog', $filterTag, 9, 1);
$hasMore  = count($stories) > 8;
...
<section id="projects">
    <h2 class="text-center text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-semibold py-4 sm:py-6 lg:py-8 px-4 text-gray-900 dark:text-white">Blogs</h2>
