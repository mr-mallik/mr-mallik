...
?>
    ...
    <section id="home" class="container mx-auto">
        <div class="flex gap-4 mb-4">
            <div class="flex items-center w-1/2 p-4 gap-4 bg-gray-900 rounded-xl">
                ...
                <div class="flex flex-col pl-4">
                    ...
                    <p class="text-gray-400">I am a Software Engineer <br/>and a Fullstack developer.</p>
                    <p class="text-gray-400 text-xs mt-4 text-justify">
                ...
                <div class="flex gap-4">
                        ...
                        <div class="p-4 bg-gray-900 rounded-xl">
                            <div class="flex flex-col gap-2">
                                <div class="h-32 overflow-hidden">
                                    <img src="<?= url('/assets/images/about-me.jpeg'); ?>" alt="About Me" class="grayscale hover:grayscale-0 transition-all duration-300 ease-in-out">
                                </div>
                    ...
                    <div class="w-1/2">
                        <div class="p-4 bg-gray-900 rounded-xl">
                            <div class="flex flex-col gap-2">
                                <div class="h-32 overflow-hidden">
                                    <img src="<?= url('/assets/images/projects.jpeg'); ?>" alt="Projects" class="grayscale hover:grayscale-0 transition-all duration-300 ease-in-out">
                                </div>
        ...
        <div class="flex flex-row gap-4 mb-4">
            ...
            <div class="w-1/4">
                <div class="p-4 bg-gray-900 rounded-xl">
                    <div class="flex flex-col gap-2">
                        <div class="h-32 overflow-hidden">
                            <img src="<?= url('/assets/images/stories.jpeg'); ?>" alt="Blogs" class="grayscale hover:grayscale-0 transition-all duration-300 ease-in-out">
                        </div>
                    ...
                    <div class="flex flex-col gap-2">
                        <div class="h-32 flex">
                            <div class="flex flex-col justify-center items-center p-4 text-center">
                                <img src="<?= url('/assets/images/coding.png'); ?>" alt="Web Development" class="dark:filter dark:invert h-20 opacity-60">
                                <span class='text-xs text-gray-400 pt-2'>Web Development</span>
                            </div>

                            <div class="flex flex-col justify-center items-center p-4 text-center">
                                <img src="<?= url('/assets/images/mobile-development.png'); ?>" alt="Mobile Development" class="dark:filter dark:invert h-20 opacity-60">
                                <span class='text-xs text-gray-400 pt-2'>Mobile Development</span>
                            </div>

                            <div class="flex flex-col justify-center items-center p-4 text-center">
                                <img src="<?= url('/assets/images/artificial-intelligence.png'); ?>" alt="AI and ML" class="dark:filter dark:invert h-20 opacity-60">
                                <span class='text-xs text-gray-400 pt-2'>AI &amp; ML</span>
                            </div>

                            <div class="flex flex-col justify-center items-center p-4 text-center">
                                <img src="<?= url('/assets/images/research-and-development.png'); ?>" alt="Research and Development" class="dark:filter dark:invert h-20 opacity-60">
                                <span class='text-xs text-gray-400 pt-2'>Research &amp; Development</span>
                            </div>

                            <div class="flex flex-col justify-center items-center p-4 text-center">
                                <img src="<?= url('/assets/images/software-development.png'); ?>" alt="Software Engineering" class="dark:filter dark:invert h-20 opacity-60">
                                <span class='text-xs text-gray-400 pt-2'>Software Engineering</span>
                            </div>
                        </div>
