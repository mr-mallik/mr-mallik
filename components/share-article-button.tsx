...
export default function ShareArticleButton({
  ...
  return (
    <button type="button" onClick={handleShare} className={className ?? "cursor-pointer text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200"}>
