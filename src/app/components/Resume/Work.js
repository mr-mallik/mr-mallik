                    ...
                    {work.map((exp, idx) => {
                        ...
                        return(
                            ...
                            className="experience-block relative pl-12 pb-5 pt-5" key={`work_${exp.id}`}>
                                ...
                                <h5 className="-ml-14 mr-3 inline-block relative px-2 py-1 text-8px tablet:text-sm border rounded bg-gray-800 border-gray-500">{`${exp.start_my} - ${exp.end_my == null ? 'Present' : exp.end_my}`}</h5>
                                <div className="pt-2"> 
